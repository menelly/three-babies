"""
Three Babies — v2/v3 Fine-Tuning Script
========================================
Trains the "why-only" (v2) and "full+why" (v3) passes.
Same locked hyperparameters as train.py.
Uses baseline models (not raised checkpoints).
...
# ============================================================
# LOCKED HYPERPARAMETERS (same as train.py / training_config.yaml)
# ============================================================
...
def train_one_pass(substrate_label: str, substrate_cfg: dict,
    ...
    log(f"Loading {substrate_cfg['base_model_path']} in 4-bit...")
...
def main():
    ...
    log(f"Three Babies v2/v3 training — passes={args.passes}, substrates={order}")
    ...
    log("All v2/v3 training complete!")
